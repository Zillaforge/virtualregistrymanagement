...
func (data *Repository) ExtractByProto(ctx context.Context, input *pb.RepositoryDetail) Repository {
	...
	data.Protect = input.Repository.Protect
...
func (data *Tag) ExtractByProto(ctx context.Context, input *pb.TagDetail) Tag {
	...
	data.Extra = extra
	data.Protect = input.Tag.Protect
...
func (data *Export) ExtractByProto(ctx context.Context, input *pb.ExportInfo) Export {
	...
	data.Type = input.Type
	data.SnapshotID = input.SnapshotID
	data.SnapshotStatus = input.SnapshotStatus
	data.VolumeID = input.VolumeID
	data.VolumeStatus = input.VolumeStatus
	data.ImageID = input.ImageID
	data.ImageStatus = input.ImageStatus
